...
def try_get_input(day: int):
    ...
    with open(f"advent_of_code_2024/day{day:>02}/input.txt", mode="wb") as f:
        f.write(r.content)
...
def main():
    try:
        ...
        if date <= datetime.date(2024, 12, 25):
            day = str(date.day).zfill(2)
        else:
            print("You need to say what day to add")
    print("Creating new day")
    print("Did you remember to change branch?")
    print(shutil.copytree(r"../advent_of_code_2023/src/advent_of_code_2023/_template", f"./advent_of_code_2024/day{day}/"))
